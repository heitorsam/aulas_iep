            ...
            <div class="container" style="position: relative; top: 50%; transform: translateY(-50%); ">
                ...
                <div class="row justify-content-center " style="" >
                    <div class="col-10" style="border-bottom: 1px solid #e7e7e7; border-top-left-radius: 5px; border-top-right-radius: 5px;">
                        ...
                        <h14><i class="fas fa-user-graduate"></i> Cadastro Aluno</h14>
                ...
                <div class="row justify-content-center ">
                    <div class="col-md-5 col-lg-5 d-none d-md-block" style="border-right: 1px solid #e7e7e7; border-bottom-left-radius: 5px;">
                        ...
                        <img class="img_redimensionada" src="iep.png" />
                        ...
                        <form method="POST" action="valida_login.php">
                            <div class="form-group">
                                ...
                                <div class="centralizar">
                                    <h13><i class="far fa-plus-square"></i> Cadastro</h13>
                                </div>

                                <div class="div_br"> </div>

                                <label for="login"><h12><i class="fas fa-user-alt"></i> Nome:</h12></label>
                                <input type="text" class="form-control" id="login" name="login" 
                                placeholder="Nome do aluno" required>

                                <div class="div_br"> </div>

                                <label for="login"><h12> <i class="fas fa-birthday-cake"></i> Data Nascimento:</h12></label>
                                <input type="date" class="form-control" id="login" name="login" required>

                                <div class="div_br"> </div>

                                <label for="login"><h12> <i class="fas fa-passport"></i> Cpf:</h12></label>
                                <input type="text" class="form-control" id="login" name="login"
                                placeholder="xxx.xxx.xxx-xx" required>

                            </div>
                            <div class="form-group">
                                <label for="senha"><h12> <i class="fas fa-key"></i> Senha:</h12></label>
                                <input type="password" class="form-control" id="senha" name="senha" required>
                            </div>
                            <button type="submit" class="botao_home" style="padding-top: 14px; padding-bottom: 14px;"> <i class="fas fa-user-plus"></i> Cadastrar</button>
                        </form>
